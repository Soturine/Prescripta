...
1. Abra `/login`, informe as credenciais do ambiente e selecione **Entrar**.
...
Não compartilhe contas nem use credenciais de produção em demonstrações. Se o papel estiver incorreto, procure um administrador em vez de contornar a restrição.
