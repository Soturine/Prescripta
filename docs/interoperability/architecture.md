...
- Importacao exige consentimento ou base legal aplicavel.
- Nenhum dado importado entra automaticamente no perfil definitivo.
- Aceite/rejeicao dependem de revisao humana e auditoria.
- A camada prepara FHIR/RNDS/HL7/CDS Hooks futuros, mas nao implementa integracao real.

## Estrutura

- `ports/`: contratos com `Protocol`.
- `adapters/fhir`: importacao demonstrativa de Bundle e recursos comuns.
