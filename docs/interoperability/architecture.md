...
- Importa??o exige consentimento ou base legal aplicavel.
- Nenhum dado importado entra automaticamente no perfil definitivo.
- Aceite/rejeicao dependem de revis?o humana e auditoria.
- A camada prepara FHIR/RNDS/HL7/CDS Hooks futuros, mas n?o implementa integracao real.

## Estrutura

- `ports/`: contratos com `Protocol`.
- `adapters/fhir`: importa??o demonstrativa de Bundle e recursos comuns.
