...
A v0.5.0 apenas documenta esta camada. Ela nao implementa FHIR/CDS Hooks nem integracao hospitalar real.
...
- Nao fazer scraping de hospitais.
- Nao armazenar credenciais de portais.
- Nao prometer integracao automatica com Santa Casa, Unimed, Policlin ou qualquer hospital sem contrato/API.
