...
Nome + data de nascimento n?o sao suficientes para mesclagem automatica. O `PatientMatchingService` retorna candidatos, score e motivos, mas exige revis?o humana.
