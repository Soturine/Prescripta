...
Nome + data de nascimento nao sao suficientes para mesclagem automatica. O `PatientMatchingService` retorna candidatos, score e motivos, mas exige revisao humana.
