...
- Medicamentos agora possuem principio ativo, aliases, fonte, jurisdicao e status de validacao.
...
## Como o modelo principio ativo primeiro reduziu duplicacao?
...
- Separacao entre principio ativo e produto.
- Fonte/jurisdicao/status em evidencias.
...
- Fontes pendentes de revisao exigem governanca.
