...
class Medication:
    ...
    def from_record(cls, record: Any) -> "Medication":
        return cls(
            ...
            dose_dimension=getattr(record, "dose_dimension", "per_administration"),
            max_daily_dose_unit=getattr(record, "max_daily_dose_unit", "mg"),
            ...
            rate_unit=getattr(record, "rate_unit", None),
