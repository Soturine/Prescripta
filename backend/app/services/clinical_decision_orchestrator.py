...
class ClinicalDecisionOrchestrator:
    ...
    def _dose_rule(self, medication: Medication) -> dict[str, Any]:
        return {
            ...
            "max_single": medication.max_single_dose,
            "max_single_unit": medication.max_single_dose_unit,
            ...
            "max_cumulative_unit": medication.max_cumulative_dose_unit,
            "rule_version": medication.dose_rule_version,
