...
Entrada: texto, URL, CSV/JSON ou base local informada pelo usuario.
...
Campos proibidos: `validated`, dose inventada, fonte inventada, decisao clinica.

Regras: se a fonte nao trouxer dado, retornar vazio ou `unknown`; status inicial
