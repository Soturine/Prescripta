export type Medication = {
  ...
  usual_dose_low?: number | null;
  usual_dose_high?: number | null;
  max_single_dose?: number | null;
  max_per_procedure?: number | null;
  dose_calculation_basis?: string;
  dose_unit?: string;
  dose_rule_validation_status?: string;
  dose_source_refs?: string[];
  controlled_substance?: boolean;
  controlled_substance_list?: string | null;
  prescription_form_type?: string | null;
  high_alert_category?: string | null;
  recommended_specialty_codes?: string[];
  required_specialty_codes?: string[];
  requires_second_review?: boolean;
  requires_institutional_protocol?: boolean;
  policy_type?: string;
  policy_strength?: string;
  policy_validation_status?: string;
  policy_source_refs?: string[];
  psychotropic_class?: string | null;
  psychotropic_profile?: Record<string, boolean | string | string[]>;
