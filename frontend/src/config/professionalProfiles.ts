...
export const CAPABILITY_LABELS: Record<Capability, string> = {
  ...
  "research.analysis.execute": "Executar análise determinística",
  "research.patient_journey.read": "Ler jornada sintética de pesquisa",
  "research.package.export": "Exportar pacote agregado de pesquisa",
